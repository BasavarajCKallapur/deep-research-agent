...
class ResearchManager:
    ...
    async def get_clarifications(self, query: str) -> ClarificationQuestions:
        """ Ask the clarifier agent for 3 questions specific to this query """
    ...
    async def run(self, query: str, answers: list[str] | None = None):
        ...
        with trace("Research trace", trace_id=trace_id):
            ...
            enriched_query = query if not answers else f"{query}\nClarifications: {answers}"
